...
const (
	...
	ProductService_AddToCart_FullMethodName        = "/product.ProductService/AddToCart"
	ProductService_RemoveFromCart_FullMethodName   = "/product.ProductService/RemoveFromCart"
)
...
func (c *productServiceClient) AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*AddToCartResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductService_AddToCart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) RemoveFromCart(ctx context.Context, in *RemoveFromCartRequest, opts ...grpc.CallOption) (*RemoveFromCartResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductService_RemoveFromCart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
